...
var urlRegExp = /^(?:(?:https?:)\/\/)(?:(?:[\u0400-\uA69F\w][\u0400-\uA69F\w-]*)?[\u0400-\uA69F\w]\.)+(?:[\u0400-\uA69Fa-z]+|\d{1,3})(?::[\d]{1,5})?(?:[/?#].*)?$/i;
var wixSVGShapeRegExp = /^wix:vector:\/\/v1\/svgshape\.v[12]/;
var wixMediaRegExp = /^wix:vector:\/\/v1\/[0-9|a-z|_]+.svg/;
