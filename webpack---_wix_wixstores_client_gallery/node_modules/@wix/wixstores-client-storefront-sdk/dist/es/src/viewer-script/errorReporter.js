...
export function createControllerRaven(platformServices, userContext, siteStore) {
    return function(dsn, ravenOptions, widgetId) {
        ...
        return function(ex, options) {
            if (siteStore.experiments.enabled('specs.stores.ReportErrorToSentry') && widgetId) {
                var fedopsLogger = platformServices.fedOpsLoggerFactory.getLoggerForWidget({
