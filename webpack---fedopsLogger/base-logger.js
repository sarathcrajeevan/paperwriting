...
export default class BaseLogger {
    ...
    reportAppPhasesNetworkAnalysis({
        ...
        for (const phaseName of phaseNames) {
            try {
                ...
                const analysis = resourceDataItem.performNetworkAnalysis(
                    resourcesInPhase,
                );
    ...
    _sendPreviousPhaseIfNeeded(name, {
        ...
        if (
            ...
            (previousPhase && previousPhase.name === CODE_PARSING_PHASE_NAME)
        ) {
    ...
    _sendLastAppLoadPhaseIfNeeded() {
        ...
        const shouldReportLastPhase =
            this.phasesConfig === phasesConfigValues.SEND_ON_START &&
            appLoadingPhase &&
            appLoadingPhase.name !== CODE_PARSING_PHASE_NAME;
    ...
    interactionEnded(
        ...
        callHook(endHook || this.endHook, {
            name: interactionName,
            duration,
            timeout: this._outgoingInteractions[interactionName] &&
