...
var CartApi = /** @class */ (function(_super) {
    ...
    CartApi.prototype.fetchCart = function(variables) {
        if (variables === void 0) {
            variables = {
                locale: 'en',
                withTax: false,
                withShipping: false,
                withMinimumOrder: false
            };
        }
        return __awaiter(this, void 0, void 0, function() {
            var response;
    ...
    CartApi.prototype.updateBuyerNote = function(data, _a) {
        var cart = _a.cart;
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_b) {
                switch (_b.label) {
    ...
    CartApi.prototype.deleteCart = function(data) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        this.siteStore.pubSubManager.publish(CartEvents.Cleared, data, false);
                        return [2 /*return*/ ];
                }
            });
        });
