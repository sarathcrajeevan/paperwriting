...
var localeDataURL = "https://static.parastorage.com/services/locale-dataset-data/" + topology.dataset + "/translations";
var LocaleData = /** @class */ (function() {
    function LocaleData(createI18Next) {
        this.translations = createI18Next({
            asyncMessagesLoader: function(locale) {
                return fetch(localeDataURL + "/messages_" + locale + ".json").then(function(res) {
    ...
    LocaleData.prototype.getCountryByKey = function(key) {
        if (GEO_CODE_MAP[key]) {
            return this.translations.t("" + COUNTRY_TRANSLATION_PREFIX + key);
        }
    };
    return LocaleData;
}());
