...
var getConditionOperationTypeAndValue = function(rule) {
    ...
    switch (op) {
        ...
        case '$hasSome':
            return {
                operation: "filled with" /* FilledWith */ ,
                value: val,
            };
        case '$exists':
            return {
...
var OppositeOperations = (_a = {},
    _a["filled" /* Filled */ ] = ["not filled" /* NotFilled */ ],
    _a["filled with" /* FilledWith */ ] = ["not filled" /* NotFilled */ ],
    _a["not filled" /* NotFilled */ ] = [
        "filled" /* Filled */ ,
...
var findContradictingRules = function(rules) {
    var reversedRules = _.reverse(__spreadArrays(rules));
