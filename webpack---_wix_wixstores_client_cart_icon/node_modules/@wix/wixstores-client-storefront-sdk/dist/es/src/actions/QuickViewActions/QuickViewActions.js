...
var QuickViewActions = /** @class */ (function() {
    ...
    QuickViewActions.prototype.getQuickViewUrl = function(_a) {
        ...
        var oldDomain = 'https://ecom.wix.com';
        var newDomain = 'https://ecom.wixapps.net';
        var url = (this.siteStore.experiments.enabled(SPECS.QUICK_VIEW_ON_WIXAPPS_DOMAIN) ? newDomain : oldDomain) + "/storefront/product/" + urlPart;
        var params = {
            layout: 'quickview',
            origin: origin,
            instance: instance,
