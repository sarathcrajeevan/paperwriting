...
import CommandsExecutor from '@wix/wixstores-client-core/dist/es/src/commands-executor';
import {
...
import {
    CartEvents,
} from '@wix/wixstores-client-core/dist/es/src/types/cart';
import {
    TrackEventName
} from '@wix/wixstores-client-core/dist/es/src/types/track-event';
...
var CartActions = /** @class */ (function(_super) {
            ...
            return __generator(this, function(_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/ , this.onAddToCartCompleted(cartSummary, addToCartAction, onSuccess)];
                }
            });
        });
    };
    ...
    CartActions.prototype.onAddToCartCompleted = function(cartSummary, addToCartAction, onSuccess) {
        ...
        this.publishCart(cartSummary, addToCartAction === AddToCartActionOption.MINI_CART);
        onSuccess();
    ...
    CartActions.prototype.publishCart = function(cartSummary, shouldOpenMiniCart) {
        if (shouldOpenMiniCart === void 0) {
        ...
        this.siteStore.pubSubManager.publish(CartEvents.CHANGED, __assign(__assign({}, publishableCart), {
            ...
            eventOptions: {
                shouldOpenCart: shouldOpenMiniCart
            }
        }));
    };
    /* istanbul ignore next: todo: test */
    ...
    CartActions.prototype.removeItemFromCart = function(_a) {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        cartSummary = _b.sent();
                        this.publishCart(cartSummary, false);
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        this.publishCart(response.data.cartSummary, false);
                        return [2 /*return*/ ];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        cartSummary = _b.sent();
                        this.publishCart(cartSummary);
                        // eslint-disable-next-line @typescript-eslint/no-floating-promises
                        this.siteStore.biLogger.couponAppliedSf({
                            origin: this.origin,
                            cartId: cartId,
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.publishCart(cartSummary);
                        // eslint-disable-next-line @typescript-eslint/no-floating-promises
                        this.siteStore.biLogger.removeACouponSf({
                            origin: this.origin,
                            storeId: this.siteStore.msid,
                            cartId: cartId,
                            couponId: couponId,
    ...
    CartActions.prototype.updateLineItemQuantityInCart = function(_a) {
        var cartId = _a.cartId,
            cartItemId = _a.cartItemId,
            quantity = _a.quantity,
            productId = _a.productId,
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.publishCart(cartSummary);
                        // eslint-disable-next-line @typescript-eslint/no-floating-promises
                        this.siteStore.biLogger.updatedCartItemQuantitySf({
                            origin: this.origin,
                            productId: productId,
    ...
    CartActions.prototype.addProductsToCart = function(products) {
        return __awaiter(this, void 0, void 0, function() {
            var data;
            var _this = this;
            return __generator(this, function(_a) {
    ...
    CartActions.prototype.reloadCart = function() {
        ...
        return this.cartApi
            ...
            .then(function(cartSummary) {
                return _this.publishCart(cartSummary, false);
            });
    };
    return CartActions;
}(BaseActions));
