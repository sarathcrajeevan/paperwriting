...
var ModalManager = /** @class */ (function() {
    function ModalManager(openModalObj, baseDomain, instance, experiments) {
    ...
    ModalManager.prototype.openNoOnlinePayments = function() {
        return __awaiter(this, void 0, void 0, function() {
            var experimentEnabled;
            return __generator(this, function(_a) {
                experimentEnabled = this.experiments && this.experiments.enabled('specs.stores.NoOnlinePaymentsNewModal');
                return [2 /*return*/ , this.openModal({
                    modalName: 'noOnlinePayments',
                    width: experimentEnabled ? 580 : 375,
                })];
            });
        });
    };
