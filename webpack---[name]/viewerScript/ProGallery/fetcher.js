...
export default class Fetcher {
    ...
    async getAppSettings() {
        if (!this.appSettingsFetchPromise) {
            ...
            try {
                ...
                this.appSettingsFetchPromise = this.appSettings.get(
                    this.dataSavedState,
                );
                const appSettings = await this.appSettingsFetchPromise;
                if (appSettings && appSettings.galleryId) {
                    ...
                    if (!this.isSSR()) {
                        ...
                        throw new Error('no galleryId in appSettings');
                    }
                }
            } catch (error) {
            ...
            return this.appSettingsFetchPromise;
        }
    }
    ...
    async getGalleryDataFromServer({
        ...
        try {
            ...
            console.error('failed to fetch from V2 server, fetching form V1');
    ...
    async getDataFromServer({
        ...
        const requestUrl = `${this.baseUrl}/pro-gallery-webapp/v1/galleries/${
      this.galleryId
