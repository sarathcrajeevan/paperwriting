...
var Translations = /** @class */ (function() {
    function Translations(_a) {
        ...
        var language = _a.language,
            ...
            autoFetchDisabled = _a.autoFetchDisabled;
        this.i18n = {};
        this.t = defaultTranslationsFunction;
        this.all = {};
        this.init = function(_a) {
            var prepopulated = (_a === void 0 ? {} : _a).prepopulated;
            return __awaiter(_this, void 0, void 0, function() {
                var config, translations, _b;
                var _this = this;
                return __generator(this, function(_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            if (!(prepopulated !== null && prepopulated !== void 0)) return [3 /*break*/ , 1];
                            _b = prepopulated;
                            return [3 /*break*/ , 3];
                        case 1:
                            return [4 /*yield*/ , getSiteTranslations(config.language, config.defaultTranslations, config.prefix, config.defaultLanguage)];
                        case 2:
                            _b = (_c.sent());
                            _c.label = 3;
                        case 3:
