...
exports.transformChatroom = function(chatroom) {
    var id = chatroom.id,
    ...
    var message = transform_message_1.transformMessage(lastMessage, public_types_1.MessageDirectionServer.CustomerToBusiness);
