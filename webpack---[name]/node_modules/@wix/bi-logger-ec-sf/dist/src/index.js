...
exports.getLoggerConf = exports.Logger = exports.initCustomLogger = void 0;
/* tslint:disable */
/* eslint:disable */
/**
 * @typedef {string} Url
...
var Logger = /** @class */ (function() {
    ...
    **/
     ...
     * @property {boolean} isMerchant - isMerchant status
     * @property {GUID} bi_token - null
     * @property {string} origin - null (from checkout page) / Minimum_order_cart / minimum_order_checkout
     ...
     * bi_token - Type: guid.
     *
     * origin - Type: string. Desc: null (from checkout page) / Minimum_order_cart / minimum_order_checkout
     *
    ...
    **/
     ...
     * @property {string} appName - app name
     * @property {string} categoryId - presented collection (if not relevant NULL)
     ...
     * appName - Type: string. Desc: app name
     *
     * categoryId - Type: string. Desc: presented collection (if not relevant NULL)
     *
