    ...
    _createClass(BiLogger, [{
        ...
        value: function log(eventOrKey, eventOrContextOrUndefined, contextOrUndefined) {
            ...
            if (fullContext.useBatch) {
                var buffer = this._initBuffer(fullContext, policy);
        ...
        key: '_initBuffer',
        value: function _initBuffer(context, policy) {
            var _this3 = this;
            ...
            return this._buffer || (this._buffer = new EventBuffer(context.useBatch === true ? 300 : context.useBatch, this._maxBatchSize).onFlush(function(batchPayload) {
                batchPayload.g = Object.assign(_this3._getStaticDefaults(_this3._defaults), _this3._getStaticNonEssentialDefaults(policy));
        ...
        value: function _getPolicyFields(policy, category) {
            return {
                _isca: policy.analytics ? 1 : 0,
                _iscf: policy.functional ? 1 : 0,
