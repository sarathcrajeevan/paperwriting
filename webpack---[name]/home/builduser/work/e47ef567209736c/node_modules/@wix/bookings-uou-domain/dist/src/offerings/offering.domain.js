...
exports.Offering = exports.OfferingFactory = exports.OfferedAsType = void 0;
var offering_dto_1 = require("./offering.dto");
Object.defineProperty(exports, "OfferedAsType", {
    enumerable: true,
    get: function() {
        return offering_dto_1.OfferedAsType;
    }
});
...
var StaffMembersExtractorFactory = /** @class */ (function() {
    ...
    StaffMembersExtractorFactory.fromDto = function(dto) {
        switch (dto.type) {
            case offering_dto_1.OfferingType.INDIVIDUAL:
                return simpleStaffMembersExtractor;
            case offering_dto_1.OfferingType.COURSE:
            case offering_dto_1.OfferingType.GROUP:
...
exports.OfferingFactory = OfferingFactory;
