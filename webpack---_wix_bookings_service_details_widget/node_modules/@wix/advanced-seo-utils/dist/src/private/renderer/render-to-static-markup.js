 ...
 */
function renderToStaticMarkup(_a, _b) {
    ...
    return render_1.render(sanitizedTags, {
            logError: logError
        })
        .map(function(element) {
            ...
            var htmlAttributes = Object.keys(props)
                ...
                .map(function(prop) {
                    return prop + "=\"" + escape_html_1.escapeHtml(props[prop]) + "\"";
                })
                .join(' ');
            var html = "<" + type;
            if (htmlAttributes) {
...
function renderChildren(props) {
    ...
    if (props && typeof props.children === 'string') {
        return escape_html_1.escapeHtml(props.children);
    }
    return '';
}