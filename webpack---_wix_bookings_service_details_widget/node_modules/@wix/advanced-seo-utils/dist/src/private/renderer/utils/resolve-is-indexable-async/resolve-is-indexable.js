...
exports.resolveIsIndexable = void 0;
...
exports.resolveIsIndexable = function(tags, adapterData) {
    ...
    var siteLevel = getIndexableValue(adapterData[utils_1.siteIDs.INDEX_SITE]); // <Boolean> (* defaults to true *)
    var patternLevel = getIndexableValue(adapterData[utils_1.siteIDs.ROBOTS_FROM_USER_PATTERN]); // <String> 'noindex' / 'index' / 'max-snippet:20' (* defaults to undefined *)
