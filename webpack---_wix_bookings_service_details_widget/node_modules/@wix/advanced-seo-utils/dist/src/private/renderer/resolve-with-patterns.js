...
var resolve_structured_data_1 = require("../tags/structured-data/resolve-structured-data");
var sort_1 = require("./sort");
var get_link_1 = require("./utils/get-link");
var fill_in_pattern_blob_1 = require("../patterns/fill-in-pattern-blob");
var adapter_static_page_1 = __importDefault(require("../item-types/static-page/adapter-static-page"));
var remove_black_listed_tags_1 = require("./utils/remove-black-listed-tags");
var apply_options_1 = require("../options/apply-options");
var resolve_twitter_image_1 = require("../utils/resolve-twitter-image");
...
function resolveWithPatterns(payload, context, options) {
    ...
    result.tags = resolve_structured_data_1.resolveStructuredData(result.tags, contextWithOptions);
    result.tags = resolve_is_indexable_1.resolveIsIndexable(result.tags, contextWithOptions);
    result.tags = result.tags
        .concat(get_link_1.getLink(contextWithOptions, adapter_static_page_1.default.IDs.NEXT, 'next'))
        .concat(get_link_1.getLink(contextWithOptions, adapter_static_page_1.default.IDs.PREV, 'prev'));
    ...
    result.tags = resolve_twitter_image_1.resolveTwitterImage(result.tags);
