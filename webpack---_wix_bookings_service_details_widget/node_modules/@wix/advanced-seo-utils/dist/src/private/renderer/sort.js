...
var META = TagTypes_1.TAG_TYPES.META,
    TITLE = TagTypes_1.TAG_TYPES.TITLE,
...
var rules = [
    ...
    and(ofType(LINK), withProp(Props_1.default.REL, 'canonical')),
    ...
    and(ofType(SCRIPT), withProp(Props_1.default.TYPE, 'application/ld+json')),
    isCustom(),
];
/**
...
function withPropProperty(value, startsWith) {
    return withProp(Props_1.default.PROPERTY, value, startsWith);
}

function withPropName(value, startsWith) {
    return withProp(Props_1.default.NAME, value, startsWith);
}
