...
var blocksControllerWrapper = function(optionalDeps, controllerDescriptor, controllerConfig) {
    ...
    if (!controllerDescriptor.method) {
        return blocksControllerService.getWrappedRemoteController(controllerConfig);
    }
    ...
    return blocksControllerService.getWrappedLocalController(controllerDescriptor, controllerConfig, flowAPI);
};
...
export var createControllers = function(optionalDeps, createController, translationsConfig, experimentsConfig, defaultTranslations, fedopsConfig, sentryConfig, biConfig, biLogger, projectName, appDefinitionId, componentId, localeDistPath, prepopulatedData, shouldUseEssentials, withErrorBoundary, widgetType) {
    ...
    return function(controllerConfigs, controllerModulesMap) {
        ...
        controllerConfigs.forEach(function(controllerConfig) {
            ...
            if (controllerDescriptor.widgetType === BLOCKS_COMPONENT_TYPE) {
                blocksControllerService.addController(controllerConfig);
            } else {
        ...
        if (blocksControllerService) {
            blocksControllerService.prepare();
        }
