import { OLD_BROWSERS_DEPRECATION_VERSION as version } from 'thunderbolt-old-browsers-static'
...
function getIframeUrlForInternetExplorerMessage() {
	...
	if (window.newDeprecatedPages) {
		return `https://static.parastorage.com/services/wix-thunderbolt/dist/deprecation-${messageLanguage}.${version}.html`
	}
