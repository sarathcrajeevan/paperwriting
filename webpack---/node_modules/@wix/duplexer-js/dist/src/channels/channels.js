...
var Channels = /** @class */ (function() {
    ...
    Channels.prototype.remove = function(name, resourceId) {
        ...
        this.channelsList = this.channelsList.filter(function(c) {
            return c.name !== name || c.resourceId !== resourceId;
        });
        return channel;
    };
    Channels.prototype.find = function(name, resourceId) {
        return this.channelsList.find(function(c) {
            return c.name === name && c.resourceId === resourceId;
        });
    };
