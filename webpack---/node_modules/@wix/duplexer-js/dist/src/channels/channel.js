...
var Channel = /** @class */ (function(_super) {
    ...
    function Channel(virtualSocket, name, resourceId, info) {
        ...
        _this.subscribingState = 1 /* UNSUBSCRIBED */ ;
        _this.name = name;
    ...
    Channel.prototype.subscribe = function(opts) {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        if (this.subscribingState === 0 /* SUBSCRIBED */ ) {
                            setTimeout(function() {
                                return _this.emitSubscriptionSucceeded(true);
                            }, 0);
                            return [2 /*return*/ ];
                        }
                        if (this.subscribingState === 2 /* SUBSCRIBING */ ) {
                            return [2 /*return*/ ];
                        }
                        this.subscribingState = 2 /* SUBSCRIBING */ ;
    ...
    Channel.prototype.setUnsubscribe = function() {
        this.subscribingState = 1 /* UNSUBSCRIBED */ ;
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (res.type === 'error') {
                            ...
                            this.subscribingState = 0 /* SUBSCRIBED */ ;
