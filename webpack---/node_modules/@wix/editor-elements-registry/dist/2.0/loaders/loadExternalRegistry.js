...
function loadExternalRegistry(_a) {
    var resourceLoader = _a.resourceLoader,
        url = _a.url,
        host = _a.host;
    return __awaiter(this, void 0, void 0, function() {
        var response, manifest, id, loadBundle, runtimeURL, bundleUrl, registry;
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    return [4 /*yield*/ , resourceLoader.fetch({
                        url: getRegistryManifestURL(url),
                    })];
                case 1:
                    response = _b.sent();
                    manifest = JSON.parse(response);
                    id = getRegistryBundleID(host);
                    if (!manifest[id + ".js"]) {
                        throw createException_1.createException(createException_1.RegistryErrorCode.NoRegistryOverrideForHost);
                    }
                    loadBundle = resourceLoader.createBundleLoader({
                        environment: {}
                    });
                    runtimeURL = manifest['webpack-runtime.js'];
                    if (!runtimeURL) return [3 /*break*/ , 3];
                ...
                case 4:
                    registry = _b.sent();
                    return [2 /*return*/ , registry.default];
            }
        });
    });
}
