...
export var messages = {
    ...
    invalidArgumentLength: function(method, from, to, actual) {
        return "WDE0008: wixData." + method + " expects between " + from + " and " + to + " arguments, but was called with " + actual + ".";
    },
    ...
    aggregateValidations: {
        aggregateInvalid: function(collectionName, invalidArguments) {
            return "Failed to perform aggregation on [" + collectionName + "].\n" + invalidArguments.join('\n');
        },
        filterMustBeBuilder: function(operatorName) {
            return "WDE0011: Invalid " + operatorName + " usage. " + operatorName + " requires WixDataFilter.";
        },
        filterIsAlreadySet: function(operatorName) {
            return "WDE0012: Invalid " + operatorName + " usage. Filter is already set.";
        },
        groupIsAlreadySet: function(operatorName) {
            return "WDE0013: Invalid " + operatorName + " usage. Group is already set.";
        },
    },
    ...
    optionsInvalid: function(properties) {
        return "WDE0018: Options must be an object with one or all of the following boolean properties: " + properties.join(', ') + ".";
    },
    ...
    referenceOperationFieldError: function(fieldName) {
        return "WDE0020: Provided relationshipAttribute [" + fieldName + "] is not a multi-reference field.";
    },
    ...
    schemaDoesNotExist: function(collectionName) {
        return "WDE0025: The " + collectionName + " collection does not exist. You cannot work with a collection using the Data API before it is created in the Editor.";
    },
    collectionDeleted: function(collectionName) {
        return "WDE0026: The " + collectionName + " collection was removed, so you cannot work with it. To restore its data, create a new collection with the same name.";
    },
    permissionDenied: function(action, collectionName) {
        return "WDE0027: The current user does not have permissions to " + action + " on the " + collectionName + " collection.";
    },
    ...
    queryValidations: {
        queryInvalid: function(collectionName, invalidArguments) {
            return "Failed to perform query on [" + collectionName + "].\n" + invalidArguments.join('\n');
        },
        ...
        isNumber: function(operatorName, specifier, operand) {
            return "WDE0032: Invalid " + operatorName + " parameter [" + typeForDisplay(operand) + "]. " + operatorName + " parameter must be a " + specifier + " number.";
        },
        isPositiveNumber: function(operatorName, operand) {
            return "WDE0033: Invalid " + operatorName + " parameter [" + operand + "]. " + operatorName + " parameter must be a positive number.";
        },
        isNonNegativeNumber: function(operatorName, operand) {
            return "WDE0034: Invalid " + operatorName + " parameter [" + operand + "]. " + operatorName + " parameter must be a non-negative number.";
        },
        isInteger: function(operatorName, operand) {
            return "WDE0035: Invalid " + operatorName + " parameter [" + operand + "]. " + operatorName + " parameter must be an integer.";
        },
        notGreaterThan: function(operatorName, operand, value) {
            return "WDE0036: Invalid " + operatorName + " parameter [" + operand + "]. " + operatorName + " parameter cannot exceed " + value + ".";
        },
        invalidSkipParameter: function(collectionName, skipParameter) {
            return "WDE0037: Invalid query on [" + collectionName + "].\nInvalid prev positioned query skip on a negative number " + skipParameter + ".";
        },
    },
    arityValidations: {
        arityIsZero: function(operatorName) {
            return "WDE0038: Invalid " + operatorName + " usage. " + operatorName + " does not take parameters.";
        },
        arityIsOne: function(operatorName) {
            return "WDE0039: Invalid " + operatorName + " usage. " + operatorName + " requires one parameter.";
        },
        arityIsTwo: function(operatorName) {
            return "WDE0040: Invalid " + operatorName + " usage. " + operatorName + " requires two parameters.";
        },
        arityIsThree: function(operatorName) {
            return "WDE0041: Invalid " + operatorName + " usage. " + operatorName + " requires three parameters.";
        },
        arityIsAtLeastTwo: function(operatorName) {
            return "WDE0042: Invalid " + operatorName + " usage. " + operatorName + " requires at least two parameters.";
        },
        arityIsAtLeastOne: function(operatorName) {
            return "WDE0043: Invalid " + operatorName + " usage. " + operatorName + " requires at least one parameter.";
        },
    },
    filterValidations: {
        typeIsString: function(operatorName, value) {
            return "WDE0044: Invalid " + operatorName + " parameter value [" + typeForDisplay(value) + "]. " + operatorName + " parameter must be a String.";
        },
        typeIsStringNumberOrDate: function(operatorName, value) {
            return "WDE0045: Invalid " + operatorName + " parameter value [" + typeForDisplay(value) + "]. Valid " + operatorName + " parameter types are String, Number or Date.";
        },
        sameType: function(operatorName, first, second) {
            return "WDE0046: Invalid " + operatorName + " parameter values [" + typeForDisplay(first) + "] and [" + typeForDisplay(second) + "]. Both parameters must be of the same type.";
        },
        typeIsStringNumberOrDateForAll: function(operatorName) {
            return "WDE0047: Invalid " + operatorName + " usage. " + operatorName + " supports only Number, String or Date items.";
        },
        validFieldName: function(operatorName, field) {
            return "WDE0048: Invalid " + operatorName + " field value [" + typeForDisplay(field) + "]. " + operatorName + " field must be a String.";
        },
        isInstanceOfSameClass: function(operatorName, constructorName, obj) {
            return "WDE0049: Invalid " + operatorName + " parameter [" + typeForDisplay(obj) + "]. " + operatorName + " expects " + constructorName + " only.";
        },
        isForCollection: function(operatorName, constructorName, collectionName) {
            return "WDE0050: Invalid " + operatorName + " parameter query for [" + collectionName + "]. " + operatorName + " accepts " + constructorName + " for the same collection only.";
        },
    ...
    filterTreeValidationsAjv: {
        objectType: function(operatorName) {
            return "WDE0056: " + operatorName + " should be an Object. Got ${0} instead";
        },
        arrayType: function(operatorName) {
            return "WDE0057: " + operatorName + " should be an Array. Got ${0} instead";
        },
        arrayLength: function(operatorName, expectedLength) {
            return "WDE0057: ${0}.length is ${0/length}. " + operatorName + " Array should have length " + expectedLength;
        },
        comparisonOperatorType: function(operatorName) {
            return "WDE0058: " + operatorName + " should be a Date, Number, or String. Got ${0} instead";
        },
        stringOperatorType: function(operatorName) {
            return "WDE0059: " + operatorName + " should be a String. Got ${0} instead";
        },
        setOperatorItems: function(operatorName) {
            return "WDE0060: " + operatorName + " Array should only contain values of types Date, Number, and String. Got ${0} instead";
        },
        ...
        matchesOperatorRequiredProperty: function(propertyName) {
            return "WDE0062: $matches value ${0} does not have property " + propertyName;
        },
    ...
    filterTreeValidations: {
        objectType: function(operatorName, value) {
            return "WDE0056: " + operatorName + " should be an Object. Got " + stringify(value) + " instead";
        },
        arrayType: function(operatorName, value) {
            return "WDE0057: " + operatorName + " should be an Array. Got " + stringify(value) + " instead";
        },
        arrayLength: function(operatorName, expectedLength, value) {
            return "WDE0057: " + stringify(value) + ".length is " + value.length + ". " + operatorName + " Array should have length " + expectedLength;
        },
        comparisonOperatorType: function(operatorName, value) {
            return "WDE0058: " + operatorName + " should be a Date, Number, or String. Got " + stringify(value) + " instead";
        },
        stringOperatorType: function(operatorName, value) {
            return "WDE0059: " + operatorName + " should be a String. Got " + stringify(value) + " instead";
        },
        setOperatorItems: function(operatorName, value) {
            return "WDE0060: " + operatorName + " Array should only contain values of types Date, Number, and String. Got " + stringify(value) + " instead";
        },
        inOperatorItems: function(value) {
            return "WDE0061: $in Array should have length 2, and match [String, Number]. Got " + stringify(value) + " instead";
        },
        matchesOperatorRequiredProperty: function(propertyName, value) {
            return "WDE0062: $matches value " + stringify(value) + " does not have property " + propertyName;
        },
        matchesOperatorIgnoreCase: function(value) {
            return "WDE0063: $matches.ignoreCase should equal true. Got " + stringify(value) + " instead";
        },
        matchesOperatorSpecItems: function(value) {
            return "WDE0064: $matches.spec Array values should be either {\"type\":\"anyOf\",\"value\":\" -\"} or {\"type\":\"literal\",\"value\":String}. Got " + stringify(value) + " instead";
        },
        regexNotAllowed: function() {
            return 'WDE0070: $regex keyword is not allowed.';
        },
    ...
    sortValidations: {
        typeIsStringOrArrayOfStrings: function(operatorName, effectiveArgs) {
            return "WDE0051: Invalid " + operatorName + " parameters [" + effectiveArgs.map(typeForDisplay) + "]. Valid " + operatorName + " values are String, Array of String or varargs String.";
        },
    },
    ...
    orderByValidations: {
        sortModelType: function(value) {
            return "WDE0065: Sort Model should be an Array. Got " + stringify(value) + " instead";
        },
        sortModelItemType: function(value) {
            return "WDE0066: Sort Model Array should contain values of type Object only. Got " + stringify(value) + " instead";
        },
        sortModelItem: function(value) {
            return "WDE0067: Sort Model Array items should have a single property with value \"asc\" or \"desc\". Got " + stringify(value) + " instead";
        },
    },
    ...
    internalError: function(message) {
        return "WDE0053: Internal wixData error: " + message;
    },
    ...
    operationNotSupported: function(collectionName, operation) {
        return collectionName + " does not support " + operation + " operation.";
    },
    ...
    itemDoesNotExist: function(id, collectionName) {
        return "WDE0073: Item [" + id + "] does not exist in collection [" + collectionName + "].";
    },
    invalidLimit: function(maxLimit) {
        return "WDE0077: 'limit' cannot exceed " + maxLimit;
    },
    ...
    invalidIdForSingleItemCollection: function(collectionName, expectedId, receivedId) {
        return "WDE0079: [" + collectionName + "] is a single item collection and item must have id [" + expectedId + "], but got [" + receivedId + "] instead.";
    },
