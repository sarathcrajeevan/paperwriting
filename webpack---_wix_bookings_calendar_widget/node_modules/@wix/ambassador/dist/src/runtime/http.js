...
var AmbassadorHTTPClient = /** @class */ (function() {
    function AmbassadorHTTPClient(baseUrl, config) {
        ...
        if (config.axiosInstance) {
            ...
            this.axiosClient = redaxios.create({
                responseType: 'json'
            });
        }
    ...
    AmbassadorHTTPClient.prototype.invoke = function(method, path, payload, headers) {
        ...
        if (this.fetchClient) {
            headers = __assign(__assign({}, headers_1.createHeaders()), headers);
            return this.fetchHttpRequest(method, encodedParamsPath, payload, headers);
        } else {
            headers = __assign(__assign({}, headers_1.createHeaders({
    ...
    AmbassadorHTTPClient.prototype.runHttpRequest = function(method, fixedPath, payload, requestConfig) {
        ...
        switch (method) {
            case 'GET':
                return this.axiosClient.get(fixedPath + "?" + this.payloadToQueryString(payload), requestConfig).then(function(res) {
                    return res.data;
                }).catch(this.handleErrors);
            case 'POST':
                return this.axiosClient.post(fixedPath, payload, requestConfig).then(function(res) {
                    return res.data;
                }).catch(this.handleErrors);
            case 'PUT':
                return this.axiosClient.put(fixedPath, payload, requestConfig).then(function(res) {
                    return res.data;
                }).catch(this.handleErrors);
            case 'PATCH':
                return this.axiosClient.patch(fixedPath, payload, requestConfig).then(function(res) {
                    return res.data;
                }).catch(this.handleErrors);
            case 'DELETE':
                return this.axiosClient.delete(fixedPath + "?" + this.payloadToQueryString(payload), requestConfig).then(function(res) {
                    return res.data;
                }).catch(this.handleErrors);
            default:
                return null;
