...
var BackInStockActions = /** @class */ (function(_super) {
    ...
    BackInStockActions.prototype.openBackInStockEmailModal = function(_a) {
        var productId = _a.productId,
            ...
            _b = _a.language,
            language = _b === void 0 ? this.siteStore.storeLanguage : _b;
        ...
        return this.siteStore.windowApis.openModal(BackInStockActions.getBackInStockModalUrl(modalOpenParam), modalOptions, this.compId);
    };
    /**
