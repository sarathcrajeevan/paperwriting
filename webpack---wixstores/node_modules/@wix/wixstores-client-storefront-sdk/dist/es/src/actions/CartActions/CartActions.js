...
var CartActions = /** @class */ (function(_super) {
    ...
    CartActions.prototype.publishCart = function(cartSummary, eventOptions) {
    ...
    CartActions.prototype.addCustomItemsToCart = function(customItems) {
        return __awaiter(this, void 0, void 0, function() {
            var customAmounts, response, cartId;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        response = _a.sent();
                        if (this.siteStore.experiments.enabled(SPECS.UPDATE_CART_IN_SYNC_FOR_ADD_CUSTOM_ITEMS_TO_CART)) {
                            cartId = response.data.cartSummary.cartId;
                            void this.cartApi.updateInSync(cartId, false);
                        }
                        this.publishCart(response.data.cartSummary, {
                            shouldOpenCart: false
                        });
                        return [2 /*return*/ ];
                }
    ...
    CartActions.prototype.reloadCart = function() {
        ...
        return this.cartApi
            ...
            .then(function(cartSummary) {
                return _this.publishCart(cartSummary, {
                    shouldOpenCart: false
                });
            });
    };
