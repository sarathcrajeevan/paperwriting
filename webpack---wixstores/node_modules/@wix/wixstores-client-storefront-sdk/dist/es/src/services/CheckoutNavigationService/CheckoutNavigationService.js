...
import {
    ModalManager
} from '@wix/wixstores-client-core/dist/es/src/modalManager/modalManager';
import {
    baseModalUrl,
    ModalType
} from './constants';
...
var CheckoutNavigationService = /** @class */ (function() {
                    ...
                    case 1:
                        {
                            ...
                            this.siteStore.biLogger.showShippingPopupSf(__assign({
    ...
    CheckoutNavigationService.prototype.checkIsAllowedToCheckout = function(_a) {
        ...
        var canStoreShipIfNeeded = areAllItemsDigital || canStoreShip;
        ...
        } else if (!isPremium || !hasCreatedPaymentMethods || !canStoreShipIfNeeded) {
