...
} from '@wix/native-components-infra/dist/es/src/sentryUtils/getReleaseFromBaseUrl';
import {
...
function openPopup(config, siteStore) {
    var popupUrl = siteStore.experiments.enabled('specs.stores.MiniCartInNewDomain') ?
        NEW_MINICART_POPUP_URL :
        MINICART_POPUP_URL;
...
export function createViewerScript(controllerFactories, options) {
    ...
    return withErrorReportingWrapping({
        ...
        createControllers: function(controllerConfigs, controllerInstances) {
            ...
            var shouldOpenMiniCart = allowMobile && isViewer && isWorker();
