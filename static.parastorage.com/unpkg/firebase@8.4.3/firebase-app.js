! function(e, t) {
    ...
    function h(e, t, n) {
        ...
        return t.code = e, t.customData = n, t.name = c, Object.setPrototypeOf(t, h.prototype), Error.captureStackTrace && Error.captureStackTrace(t, d.prototype.create), t
    }
    ...
    var b = (w.prototype.next = function(t) {
        ...
        void 0 === (r = function(e, t) {
            ...
            error: t,
            complete: n
        }).next && (r.next = I), void 0 === r.error && (r.error = I), void 0 === r.complete && (r.complete = I);
        ...
        N = (L.prototype.get = function(e) {
            ...
            return e(this, void 0, void 0, function() {
                ...
                return n(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return t = Array.from(this.instances.values()), [4, Promise.all(a(a([], p(t.filter(function(e) {
            ...
            if (!r && this.component && (r = this.component.instanceFactory(this.container, {
                    ...
                    options: e
                }), this.instances.set(t, r), this.component.onInstanceCreated)) try {
    ...
    var S = (C.prototype.addComponent = function(e) {
    ...
    var R, A = [];
    (F = R = R || {})[F.DEBUG = 0] = "DEBUG", F[F.VERBOSE = 1] = "VERBOSE", F[F.INFO = 2] = "INFO", F[F.WARN = 3] = "WARN", F[F.ERROR = 4] = "ERROR", F[F.SILENT = 5] = "SILENT";
    ...
    var D = {
        ...
        j = R.INFO,
        z = ((x = {})[R.DEBUG] = "log", x[R.VERBOSE] = "log", x[R.INFO] = "info", x[R.WARN] = "warn", x[R.ERROR] = "error", x),
        F = (Object.defineProperty(k.prototype, "logLevel", {
            get: function() {
    ...
    function H(a, t) {
        for (var e = 0, n = A; e < n.length; e++) ! function(e) {
            var o = null;
            t && t.level && (o = D[t.level]), e.userLogHandler = null === a ? null : function(e, t) {
                for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
    ...
    var x = ((x = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()", x["bad-app-name"] = "Illegal App name: '{$appName}", x["duplicate-app"] = "Firebase App named '{$appName}' already exists", x["app-deleted"] = "Firebase App named '{$appName}' already deleted", x["invalid-app-argument"] = "firebase.{$appName}() takes either no argument or a Firebase App instance.", x["invalid-log-argument"] = "First argument to `onLog` must be null or a function.", x),
        B = new d("app", "Firebase", x),
        V = "@firebase/app",
        M = "[DEFAULT]",
        U = ((x = {})[V] = "fire-core", x["@firebase/analytics"] = "fire-analytics", x["@firebase/auth"] = "fire-auth", x["@firebase/database"] = "fire-rtdb", x["@firebase/functions"] = "fire-fn", x["@firebase/installations"] = "fire-iid", x["@firebase/messaging"] = "fire-fcm", x["@firebase/performance"] = "fire-perf", x["@firebase/remote-config"] = "fire-rc", x["@firebase/storage"] = "fire-gcs", x["@firebase/firestore"] = "fire-fst", x["fire-js"] = "fire-js", x["firebase-wrapper"] = "fire-js-all", x),
    ...
    function $(e, t, n) {
        var r = this;
        this.firebase_ = n, this.isDeleted_ = !1, this.name_ = t.name, this.automaticDataCollectionEnabled_ = t.automaticDataCollectionEnabled || !1, this.options_ = f(void 0, e), this.container = new S(t.name), this._addComponent(new E("app", function() {
            return r
    ...
    function J(a) {
        var s = {},
            ...
            l = {
                ...
                initializeApp: function(e, t) {
                    ...
                    t = n.name;
                    if ("string" != typeof t || !t) throw B.create("bad-app-name", {
                        appName: String(t)
                    });
                    if (y(s, t)) throw B.create("duplicate-app", {
                        appName: t
                    });
                    n = new a(e, n, l);
                    return s[t] = n
                ...
                registerVersion: function(e, t, n) {
                    ...
                    if (i || e) {
                        ...
                        return i && n.push('library name "' + r + '" contains illegal characters (whitespace or "/")'), i && e && n.push("and"), e && n.push('version name "' + t + '" contains illegal characters (whitespace or "/")'), void W.warn(n.join(" "))
                    }
                    o(new E(r + "-version", function() {
                        return {
                            library: r,
                            version: t
                        }
        ...
        function u(e) {
            if (!y(s, e = e || M)) throw B.create("no-app", {
                appName: e
            });
            return s[e]
        }
        ...
        function o(n) {
            var e, r = n.name;
            if (c.has(r)) return W.debug("There were multiple attempts to register component " + r + "."), "PUBLIC" === n.type ? l[r] : null;
            c.set(r, n), "PUBLIC" === n.type && (e = function(e) {
                if ("function" != typeof(e = void 0 === e ? u() : e)[r]) throw B.create("invalid-app-argument", {
                    appName: r
                });
                return e[r]()
            }, void 0 !== n.serviceProps && f(e, n.serviceProps), l[r] = e, a.prototype[r] = function() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    ...
    var x = function e() {
        ...
        K = (X.prototype.getPlatformInfoString = function() {
    ...
    (q = ee).INTERNAL.registerComponent(new E("platform-logger", function(e) {
        return new K(e)
    }, "PRIVATE")), q.registerVersion(V, "0.6.20", Q), q.registerVersion("fire-js", "");
