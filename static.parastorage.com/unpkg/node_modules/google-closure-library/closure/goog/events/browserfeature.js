...
exports = {
     ...
     * keyCode to -1.
     */
    SET_KEY_CODE_TO_PREVENT_DEFAULT: googUserAgent.IE && !googUserAgent.isVersionOrHigher('9'),
     ...
     */
    HAS_HTML5_NETWORK_EVENT_SUPPORT: googUserAgent.GECKO && googUserAgent.isVersionOrHigher('1.9b') ||
     ...
     * window.
     */
    HTML5_NETWORK_EVENTS_FIRE_ON_BODY: googUserAgent.GECKO && !googUserAgent.isVersionOrHigher('8') ||
